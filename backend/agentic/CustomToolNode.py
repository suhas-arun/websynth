...
TOOL_CALL_ERROR_TEMPLATE = "Error: {error}\n Remember this is the function schema {schema}. \n Please fix your mistakes, ensure you are filling all REQUIRED parameters!"
...
def _handle_tool_error(
    ...
    *,
    ...
    if isinstance(flag, (bool, tuple)):
        content = TOOL_CALL_ERROR_TEMPLATE.format(error=repr(e), schema=str(schema))
...
class WebSynthToolNode(RunnableCallable):
    ...
    def _run_one(
        ...
        # (2 and 3 can happen in a "supervisor w/ tools" multi-agent architecture)
            ...
            # Handled
                ...
                content = _handle_tool_error(e, flag=self.handle_tool_errors, schema=self.tools_by_name[call["name"]].input_schema.model_json_schema())
            return ToolMessage(
                content=content,
                name=call["name"],
